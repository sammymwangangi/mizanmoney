...
export default function Navbar() {
  ...
  return (
    <Popover>
      <div className="ml-[22px] lg:ml-[126px] mr-[57px] pt-[32px] lg:pt-[44px]">
        <div className="flex items-center justify-between space-x-[4 0px] md:space-x-[50px]">
          <div className="flex justify-start w-[100px] lg:w-[210px] xl:w-[580px] 2xl:w-[720px]">
            <Link href="/">
              <svg
                width="150"
                height="77"
          ...
          >
            {({ open }) => (
              <>
                ...
                >
                  <Popover.Panel className="absolute left-1/2 z-10 w-40 max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
