...
import saalam from "../styles/header.module.css";
import pr_1 from "../styles/header.module.css";
import pr_2 from "../styles/header.module.css";
import phone from "../styles/header.module.css";
import mobilePic from "../public/mobile.svg";
    ...
    <div className="relative overflow-hidden">
      <div className="mx-auto max-w-[1265px]">
        <div className="relative z-10">
          <Popover>
            <div className="px-2 sm:px-6 pt-[35px]">
              <div className="flex items-center justify-between md:justify-start md:space-x-[50px]">
                ...
                <Popover.Group
                  as="nav"
                  className="hidden space-x-[72px] md:flex"
                >
          ...
          <main className="max-w-2xl mt-10 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className={header.pr_2}>
                We are excited to have crafted a piece of tech that is seamless,
                without walls, borders or physical limits, built on an ethical
                islamic framework.
              </p>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-full shadow">
                  <div className={header.waitlist}>
                    <a
                      href="#"
                      className="flex w-full items-center justify-center rounded-full border border-transparent text-white md:py-4 md:px-10 md:text-lg"
                    >
                      JOIN WAITLIST
                    </a>
                  </div>
                ...
                <div className="flex mt-3 sm:mt-0 sm:ml-3">
                  <a
                    href="#"
                    className="flex w-full items-center justify-center rounded-full border border-transparent bg-indigo-100 px-8 py-3 text-base font-medium text-indigo-700 hover:bg-indigo-200 md:py-4 md:px-10 md:text-lg"
                  >
                    <span>SEE HOW</span>
                    <span>
                      <svg
      ...
      <div className="lg:absolute inset-y-0 lg:right-0 z-30">
        <Image
          src={phonePic}
          alt="Phone"
          width={662}
